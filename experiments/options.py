...
parser.add_argument('--triplet_mode', type=str, default='batch_hard', choices=['category', 'hard', 'batch_hard'])
parser.add_argument('--categories_per_batch', type=int, default=8)
parser.add_argument('--instances_per_category', type=int, default=8)
